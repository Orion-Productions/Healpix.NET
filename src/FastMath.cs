...
namespace Healpix
{
    ...
    */
    public class FastMath {
        ...
        private static double sign(double d) { return (d==0)? 1 : Math.Sign(d); }
        ...
        private static double PI4_A = .7853981554508209228515625;
        private static double PI4_B
            = .794662735614792836713604629039764404296875e-8;
        private static double PI4_C
            = .306161699786838294306516483068750264552437361480769e-16;
        private static double M_1_PI = 0.3183098861837906715377675267450287;
