...
namespace Healpix
{
    ...
    */
    ...
    public class HealpixUtils
    {
        ...
        {
            return 63 - (arg>0? 64-Convert.ToString(arg,2).Length : 63);  // NOTE: Not sure if this is correct
        }
        ...
        /** Computes the cosine of the angular distance between two z, phi positions
            on the unit sphere. */
        static public double cosdist_zphi (double z1, double phi1, double z2, double phi2)
        {
        ...
        static public int uniq2order (long uniq)
            { return (int)((uint)ilog2((long)(ulong)uniq>>2)>>1); }
